...
uint8_t __GLCD_Buffer[128][64 / 8];

GLCD_t __GLCD;
# 20 "LCD-KS0108/KS0108.c"
...
static __attribute__((inline)) void Pulse_En(void);
...
void GLCD_SendCommand(const uint8_t Command, enum Chip_t Chip)
{
 ...
 ( 0 ? ( ( (LATD) |= (1UL<<4) ) ) : ( ( (LATD) &= (~(1UL<<4)) ) ) );
 ( 0 ? ( ( (LATD) |= (1UL<<3) ) ) : ( ( (LATD) &= (~(1UL<<3)) ) ) );
...
void GLCD_Setup(void)
{
 ...
 ( !1 ? ( ( (TRISE) |= (1UL<<0) ) ) : ( ( (TRISE) &= (~(1UL<<0)) ) ) );
 ( !1 ? ( ( (TRISE) |= (1UL<<1) ) ) : ( ( (TRISE) &= (~(1UL<<1)) ) ) );
 ( !1 ? ( ( (TRISE) |= (1UL<<2) ) ) : ( ( (TRISE) &= (~(1UL<<2)) ) ) );
 ( !1 ? ( ( (TRISE) |= (1UL<<3) ) ) : ( ( (TRISE) &= (~(1UL<<3)) ) ) );
 ( !1 ? ( ( (TRISE) |= (1UL<<4) ) ) : ( ( (TRISE) &= (~(1UL<<4)) ) ) );
 ( !1 ? ( ( (TRISE) |= (1UL<<5) ) ) : ( ( (TRISE) &= (~(1UL<<5)) ) ) );
 ( !1 ? ( ( (TRISE) |= (1UL<<6) ) ) : ( ( (TRISE) &= (~(1UL<<6)) ) ) );
 ( !1 ? ( ( (TRISE) |= (1UL<<7) ) ) : ( ( (TRISE) &= (~(1UL<<7)) ) ) );



 ( !1 ? ( ( (TRISD) |= (1UL<<0) ) ) : ( ( (TRISD) &= (~(1UL<<0)) ) ) );
 ( !1 ? ( ( (TRISD) |= (1UL<<1) ) ) : ( ( (TRISD) &= (~(1UL<<1)) ) ) );
 ( !1 ? ( ( (TRISD) |= (1UL<<4) ) ) : ( ( (TRISD) &= (~(1UL<<4)) ) ) );
 ( !1 ? ( ( (TRISD) |= (1UL<<7) ) ) : ( ( (TRISD) &= (~(1UL<<7)) ) ) );
 ( !1 ? ( ( (TRISD) |= (1UL<<3) ) ) : ( ( (TRISD) &= (~(1UL<<3)) ) ) );
 ( !1 ? ( ( (TRISD) |= (1UL<<2) ) ) : ( ( (TRISD) &= (~(1UL<<2)) ) ) );

 ( 0 ? ( ( (LATD) |= (1UL<<4) ) ) : ( ( (LATD) &= (~(1UL<<4)) ) ) );
 ( 0 ? ( ( (LATD) |= (1UL<<3) ) ) : ( ( (LATD) &= (~(1UL<<3)) ) ) );
 ( 0 ? ( ( (LATD) |= (1UL<<7) ) ) : ( ( (LATD) &= (~(1UL<<7)) ) ) );

 ( 0 ? ( ( (LATD) |= (1UL<<2) ) ) : ( ( (LATD) &= (~(1UL<<2)) ) ) );
 _delay((unsigned long)((5)*(24000000/4000.0)));
 ( !0 ? ( ( (LATD) |= (1UL<<2) ) ) : ( ( (LATD) &= (~(1UL<<2)) ) ) );
 _delay((unsigned long)((50)*(24000000/4000.0)));


 GLCD_SendCommand(0x3F, Chip_All);
 GLCD_SendCommand(0xC0, Chip_All);
...
void GLCD_Render(void)
{
 ...
 for (j = 0 ; j < 64 ; j += 8)
 {
  ...
  __GLCD_GotoY(j);
  for (i = 0 ; i < 128 ; i++)
   GLCD_SendData(GLCD_BufferRead(i, __GLCD.Y), ((i < (128 / 2)) ? Chip_1 : Chip_2));
 }
}
 ...
 (Y1 < 64) && (Y2 < 64))
 {
  ...
  else
  {
   ...
   if (slope)
   {
    ...
    do{ uint8_t t = X1; X1 = Y1; Y1 = t; }while(0);

    do{ uint8_t t = X2; X2 = Y2; Y2 = t; }while(0);
   }
   if (X1 > X2)
   {

    do{ uint8_t t = X1; X1 = X2; X2 = t; }while(0);

    do{ uint8_t t = Y1; Y1 = Y2; Y2 = t; }while(0);
   }
...
void GLCD_DrawRoundRectangle(const uint8_t X1, const uint8_t Y1, const uint8_t X2, const uint8_t Y2, const uint8_t Radius, enum Color_t Color)
{
 ...
 (Y1<64) && (Y2<64))
 {
  ...
  GLCD_DrawHLine(X1+Radius, X2-Radius, Y1, Color);
  GLCD_DrawHLine(X1+Radius, X2-Radius, Y2, Color);
  GLCD_DrawVLine(Y1+Radius, Y2-Radius, X1, Color);
  GLCD_DrawVLine(Y1+Radius, Y2-Radius, X2, Color);
...
{
 if (((CenterX + Radius) < 128) && ((CenterY + Radius) < 64))
 {
  uint8_t x, y;
...
void GLCD_FillRoundRectangle(const uint8_t X1, const uint8_t Y1, const uint8_t X2, const uint8_t Y2, const uint8_t Radius, enum Color_t Color)
{
 ...
 (Y1 < 64) && (Y2 < 64))
 {
  ...
  while (x <= y)
  {
   ...
   GLCD_DrawLine(
   X1 + Radius - x, Y1 + Radius - y,
   X1 + Radius - x, Y1 + height - Radius + y,
   Color);
   GLCD_DrawLine(
   X1 + Radius - y, Y1 + Radius - x,
   X1 + Radius - y, Y1 + height - Radius + x,
   Color);


   GLCD_DrawLine(
   X1 + width - Radius + x, Y1 + Radius - y,
   X1 + width - Radius + x, Y1 + height - Radius + y,
   Color);
   GLCD_DrawLine(
   X1 + width - Radius + y, Y1 + Radius - x,
   X1 + width - Radius + y, Y1 + height - Radius + x,
   Color);
...
void GLCD_FillTriangle(uint8_t X1, uint8_t Y1, uint8_t X2, uint8_t y2, uint8_t X3, uint8_t Y3, enum Color_t Color)
{
 ...
 (Y1 < 64) && (y2 < 64) && (Y3 < 64)))
 {
  ...
  if (y2 > Y3)
  {
   do{ uint8_t t = X2; X2 = X3; X3 = t; }while(0);
   do{ uint8_t t = y2; y2 = Y3; Y3 = t; }while(0);
  }
  if (Y1 > y2)
  {
   do{ uint8_t t = X1; X1 = X2; X2 = t; }while(0);
...
void GLCD_SetFont(const uint8_t *Name, const uint8_t Width, const uint8_t Height, enum PrintMode_t Mode, enum OperatingMode_t Invert)
{
 if ((Width < 128) && (Height < 64) && ((Mode == GLCD_Overwrite) || (Mode == GLCD_Merge)))
 {
  ...
  __GLCD.Font.Lines = Height / 8 + (( (Height % 8) != 0) ? 1 : 0);
...
static void GLCD_Send(const uint8_t Data)
{
 ...
 ( ( Data & (1UL<<0) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<0) ) ) : ( ( (LATE) &= (~(1UL<<0)) ) ) );
 ( ( Data & (1UL<<1) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<1) ) ) : ( ( (LATE) &= (~(1UL<<1)) ) ) );
 ( ( Data & (1UL<<2) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<2) ) ) : ( ( (LATE) &= (~(1UL<<2)) ) ) );
 ( ( Data & (1UL<<3) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<3) ) ) : ( ( (LATE) &= (~(1UL<<3)) ) ) );
 ( ( Data & (1UL<<4) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<4) ) ) : ( ( (LATE) &= (~(1UL<<4)) ) ) );
 ( ( Data & (1UL<<5) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<5) ) ) : ( ( (LATE) &= (~(1UL<<5)) ) ) );
 ( ( Data & (1UL<<6) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<6) ) ) : ( ( (LATE) &= (~(1UL<<6)) ) ) );
 ( ( Data & (1UL<<7) ? 1 : 0 ) ? ( ( (LATE) |= (1UL<<7) ) ) : ( ( (LATE) &= (~(1UL<<7)) ) ) );
 Pulse_En();
}
...
static void GLCD_SelectChip(enum Chip_t Chip)
{
 ...
 if(Chip == Chip_1)
 {
  ( off ? ( ( (LATD) |= (1UL<<1) ) ) : ( ( (LATD) &= (~(1UL<<1)) ) ) );
  ( on ? ( ( (LATD) |= (1UL<<0) ) ) : ( ( (LATD) &= (~(1UL<<0)) ) ) );
 }
 else if (Chip == Chip_2)
 {
  ( off ? ( ( (LATD) |= (1UL<<0) ) ) : ( ( (LATD) &= (~(1UL<<0)) ) ) );
  ( on ? ( ( (LATD) |= (1UL<<1) ) ) : ( ( (LATD) &= (~(1UL<<1)) ) ) );
 }
 else
 {
  ( on ? ( ( (LATD) |= (1UL<<0) ) ) : ( ( (LATD) &= (~(1UL<<0)) ) ) );
...
static void __GLCD_GotoX(const uint8_t X)
{
 if (X < 128)
 {
  ...
  chip = ((X < (128 / 2)) ? Chip_1 : Chip_2);
  cmd = ((chip == Chip_1) ? (0x40 | X) : (0x40 | (X - 128 / 2)));
