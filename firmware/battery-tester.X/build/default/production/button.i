...
{
   return ( ( ( (PORTC) & (1UL<<7) ? 1 : 0 ) ) );
}

uint8_t ButtonLeft(void)
{
   return ( ( ( (PORTC) & (1UL<<6) ? 1 : 0 ) ) );
}

uint8_t ButtonUp(void)
{
   return ( ( ( (PORTG) & (1UL<<0) ? 1 : 0 ) ) );
}

uint8_t ButtonDown(void)
{
   return ( ( ( (PORTG) & (1UL<<4) ? 1 : 0 ) ) );
}

uint8_t ButtonOK(void)
{
   return ( ( ( (PORTG) & (1UL<<3) ? 1 : 0 ) ) );
}


btn_instance_t instance[2] =
{
  {
...
void Button_Init(void)
{
    ( 1 ? ( ( (TRISC) |= (1UL<<6) ) ) : ( ( (TRISC) &= (~(1UL<<6)) ) ) );
    ( 1 ? ( ( (TRISC) |= (1UL<<7) ) ) : ( ( (TRISC) &= (~(1UL<<7)) ) ) );
    ( 1 ? ( ( (TRISG) |= (1UL<<0) ) ) : ( ( (TRISG) &= (~(1UL<<0)) ) ) );
    ( 1 ? ( ( (TRISG) |= (1UL<<4) ) ) : ( ( (TRISG) &= (~(1UL<<4)) ) ) );
    ( 1 ? ( ( (TRISG) |= (1UL<<3) ) ) : ( ( (TRISG) &= (~(1UL<<3)) ) ) );



  this.process_time_ms = (this.process_time_ms) ? this.process_time_ms : (10);
  this.debounce_time_ms = (this.debounce_time_ms) ? this.debounce_time_ms : (20);
  this.long_press_def_ms = (this.long_press_def_ms) ? this.long_press_def_ms : (1000);
...
void Button_Update(void)
{
  ...
  if(button_counter>=10)
  {
    while(key < 2)
    {
      ...
      if (BTN_STATE_SHORT == now_pressed)
      {
        if (!this.instance[key].state.locked)
        {
          if (++this.instance[key].lock_count >= (this.debounce_time_ms / this.process_time_ms))
          {
        ...
        {
          if (++this.instance[key].long_count >= (this.instance[key].long_press_time_ms / this.process_time_ms))
          {
            this.instance[key].state.act = BTN_STATE_LONG;
            if (((void*)0) != this.long_press) this.long_press(key);
          }
        }
        this.instance[key].state.prew = now_pressed;
      }
      else if (BTN_STATE_NONE == now_pressed)
      {
        if (this.instance[key].state.locked)
        {
          ...
          else
          {
            ...
            if (this.instance[key].long_count < (this.instance[key].long_press_time_ms / this.process_time_ms))
            {
              if (0 == this.instance[key].lock_count)
              {
                ...
                if (((void*)0) != this.short_release) this.short_release(key);
              }
            }
            else
            {
              ...
              {
                if (((void*)0) != this.long_release) this.long_release(key);
              }
            }
          }
        }
