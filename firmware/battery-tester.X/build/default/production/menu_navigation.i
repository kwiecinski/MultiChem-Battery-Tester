...
typedef void (*btn_ev_cb_t)(buttons btn_code);
# 175 "./button.h"
typedef struct {
  struct {
    uint8_t act : 2;
    ...
    if (Button_EventGet(UP_SW) || Button_EventGet(DOWN_SW))
    {
        if(menu_type==settings1)
        {
            ...
            if(param_pos == param_1)
            {
                ...
                ChemistryDisplay(bat_param, 1);
                CellCount(bat_param, 0);
                ChargerMode(bat_param, 0);
                CycleSet(bat_param, 0);
        ...
        }else if(menu_type==settings2)
        {
            ...
            if(param_pos == param_1)
            {
                SetCellVotage(bat_param, 1);
                MinimumDischargeVoltage(bat_param, 0);
                TrickleCurrent(bat_param, 0);
                TrickleVoltage(bat_param, 0);
                Handle_Setting23_MenuNavigation(disable_start_next_menu);
            }else if(param_pos == param_2)
            {
                SetCellVotage(bat_param, 0);
                MinimumDischargeVoltage(bat_param, 1);
                TrickleCurrent(bat_param, 0);
                TrickleVoltage(bat_param, 0);
                Handle_Setting23_MenuNavigation(disable_start_next_menu);
            }else if(param_pos == param_3)
        ...
        }else if(menu_type==settings4)
        {
            ...
            if(param_pos == param_1)
            {
                ...
                SetDischargingCurrent_1(bat_param, 0);
            ...
            {
                SetChargingCurrent_1(bat_param, 0);
    ...
    if (Button_EventGet(LEFT_SW) || Button_EventGet(RIGHT_SW) || menu_init==0 )
    {
        ...
        }else if(menu_type==settings1)
        {
            ...
            }else if(param_pos == param_4)
            {
                ...
                }else if(bat_param->set_cycle>=4 +1)
                {
        ...
        }else if(menu_type==settings2)
        {
            ...
            }else if(param_pos == param_1)
            {
                ...
                if(bat_param->batt_set_voltage<410 -1)
                {
                    bat_param->batt_set_voltage = 430;

                }else if(bat_param->batt_set_voltage>430 +1)
                {
                    bat_param->batt_set_voltage = 410;
                }
            ...
            }else if(param_pos == param_2)
            {
                ...
                if(bat_param->batt_set_min_discharge_voltage<250 -1)
                {
                    bat_param->batt_set_min_discharge_voltage = 320;

                }else if(bat_param->batt_set_min_discharge_voltage>320 +1)
                {
                    bat_param->batt_set_min_discharge_voltage = 250;
                }
            ...
            }else if(param_pos == param_3)
            {
                ...
                if(bat_param->batt_set_trickle_voltage<180 -1)
                {
                    bat_param->batt_set_trickle_voltage = 250;

                }else if(bat_param->batt_set_trickle_voltage>250 +1)
                {
                    bat_param->batt_set_trickle_voltage = 180;
                }
    ...
    if (Button_EventGet(OK_SW))
    {
        ...
        }else if(menu_type==settings4)
        {
            ...
            }else if(param_pos == param_3)
            {
                if(bat_param->precent_current_flags & (1 << 0))
                {
                    bat_param->precent_current_flags &= ~(1 << 0);;
                }else
                {
                    bat_param->precent_current_flags |= (1 << 0);;
                }
            ...
            }else if(param_pos == param_4)
            {
                ...
                if(bat_param->precent_current_flags & (1 << 1))
                {
                    bat_param->precent_current_flags &= ~(1 << 1);;
                }else
                {
                    bat_param->precent_current_flags |= (1 << 1);;
                }
